...
export default function Domicilios() {
  ...
  const send = async () => {
    ...
    try {
      ...
      alert(e.response?.data?.error || 'Error al enviar domicilio');
    }
  };
      ...
      <div className="pedido-content">
        <div className="pedido-items">
          ...
          <div className="form-group">
            <label>Nota cliente / dirección (temporal)</label>
            <input value={customerNote} onChange={(e) => setCustomerNote(e.target.value)} placeholder="Nombre + dirección + tel" />
          </div>
        </div>
