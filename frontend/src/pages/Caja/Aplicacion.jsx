...
// Junta lo que antes eran 4 entradas sueltas en OPCIONES (BUSCAR
// ACTUALIZACIONES, DESCARGAR DATOS, RESTAURAR DATOS, COPIA DE SEGURIDAD):
// todo lo que es mantenimiento de la app/datos, no del día a día del negocio.
export default function Aplicacion() {
  ...
  return (
    <div className="caja-container">
      <CajaHeader title="APLICACIÓN" backTo="/mas" />
